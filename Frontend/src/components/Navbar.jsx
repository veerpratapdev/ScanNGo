      ...
      <div className='flex justify-between items-center'>
        ...
        <div className='hidden md:flex gap-8 items-center text-lg font-medium'>
          ...
          <div className='relative'>
            ...
            {openProfile && (
              <div className='absolute right-0 mt-3 w-48 bg-white text-gray-700 rounded-xl shadow-xl overflow-hidden'>

                <Link to='/profile' className='block px-5 py-3 hover:bg-blue-50'>
                  Profile
                </Link>

                <Link to='/my-orders' className='block px-5 py-3 hover:bg-blue-50'>
                  My Orders
                </Link>
